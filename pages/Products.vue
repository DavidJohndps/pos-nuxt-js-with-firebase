    ...
    <v-col v-for="product in Products" :key="product.id" cols="12" md="4">
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn rounded icon outlined color="error" @click="Delete(product.id)">
      ...
      <v-card>
        ...
        <v-card-text>
          <v-container>
            <v-row>
              <v-col cols="12">
                <v-text-field label="Nama Barang*" :rules="nameRule" required @change="updateName" :value="Product.name"></v-text-field>
              </v-col>
              <v-col cols="12" md="4">
                <v-text-field label="Harga Barang*" :rules="priceRule" required @change="updatePrice" :value="Product.base_price"></v-text-field>
              </v-col>
              <v-col cols="12" md="4">
                <v-text-field label="Profit*" :rules="profitRule" required @change="updateProfit" :value="Product.profit"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="4">
                <v-text-field label="Stock*" :rules="stockRule" required @change="updateStock" :value="Product.stock"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <v-text-field label="Discount 1*" :rules="discount1Rule" required @change="updateDisc1" :value="Product.discount1"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <v-text-field label="Discount 1 Quantity*" :rules="discount1QtyRule" required @change="updateDisc1Qty" :value="Product.discount1Qty"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <v-text-field label="Discount 2*" :rules="discount2Rule" required @change="updateDisc2" :value="Product.discount2"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <v-text-field label="Discount 2 Quantity*" :rules="discount2QtyRule" required @change="updateDisc2Qty" :value="Product.discount2Qty"></v-text-field>
              </v-col>
              <v-col cols="12">
                <v-textarea
                  auto-grow
        ...
        <v-card-actions>
          ...
          <v-btn color="success" text @click="fakefill">
            FakeFill
          </v-btn>
        </v-card-actions>
      </v-card>
